...
func (l *LlamaToolHandler) ListTools() []LlamaTool {
	return []LlamaTool{
		...
		},
		{
			...
			Function: LlamaToolFunction{
				Name:        "system_info",
				Description: "查询当前运行环境的基础系统信息（操作系统、架构、CPU 核数、Go 版本、主机名、用户、发行版等）。",
				Parameters: map[string]interface{}{
					"type":     "object",
					"properties": map[string]interface{}{},
				},
		...
		},
		{
			...
			Function: LlamaToolFunction{
				Name:        "system_dirs",
				Description: "识别并返回当前操作系统的标准系统目录（Windows / Linux），并标记是否存在。",
				Parameters: map[string]interface{}{
					"type":     "object",
					"properties": map[string]interface{}{},
				},
		...
		},
		{
			Type: "function",
			Function: LlamaToolFunction{
				Name:        "read_system_dir",
				Description: "读取任意目录（系统级，不受沙箱限制），用于浏览 Windows / Linux 系统目录。",
				Parameters: map[string]interface{}{
					"type": "object",
					"properties": map[string]interface{}{
						"path":       map[string]interface{}{"type": "string", "description": "目录路径，留空=.；可为绝对路径如 C:\\Windows 或 /etc"},
						"max_entries": map[string]interface{}{"type": "integer", "description": "最多返回条目数，默认500，最大2000"},
					},
				},
			},
		},
		{
			...
			Function: LlamaToolFunction{
				Name:        "get_env",
				Description: "读取环境变量。name 为空时返回全部环境变量。",
				Parameters: map[string]interface{}{
					"type": "object",
					"properties": map[string]interface{}{
						"name": map[string]interface{}{"type": "string", "description": "环境变量名，留空返回全部"},
					},
				},
			},
		},
		{
			...
			Function: LlamaToolFunction{
				Name:        "disk_usage",
				Description: "查询指定路径所在磁盘的空间使用情况（总量、已用、可用、使用率）。",
				Parameters: map[string]interface{}{
					"type": "object",
					"properties": map[string]interface{}{
						"path": map[string]interface{}{"type": "string", "description": "目录或盘符路径，留空=. 当前目录"},
					},
				},
			},
		},
...
func (l *LlamaToolHandler) CallTool(ctx context.Context, req LlamaToolCallRequest) (interface{}, error) {
	...
	case "system_info":
		return l.h.systemInfo(req.Arguments)
	case "system_dirs":
		return l.h.systemDirs(req.Arguments)
	case "read_system_dir":
		return l.h.readSystemDir(req.Arguments)
	case "get_env":
		return l.h.getEnv(req.Arguments)
	case "disk_usage":
		return l.h.diskUsage(req.Arguments)
	default:
